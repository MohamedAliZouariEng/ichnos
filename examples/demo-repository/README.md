...
- `src/quire/` is a small Python code skeleton (invitations and tokens, with tests in `tests/`), written before invitation expiry exists, so the Stories have real code to change.
